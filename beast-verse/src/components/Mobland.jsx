...
function Mobland() {
  return (
    ...
    <img className="brightness-75 -z-10" alt="" src={island}></img>
    <div className='container  absolute top-0 left-0 mx-auto text-center text-white font-semibold font-Monstserrat h-[80vh] flex flex-col items-center justify-center'>
    <img src={logo} alt="bv_logo" className='w-[60%] mx-auto' />
