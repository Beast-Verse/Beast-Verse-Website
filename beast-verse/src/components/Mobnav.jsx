    ...
    <div>
      <div className="fixed top-0 z-20 w-full  ">
        ...
        <ul className={`${open?'block':'hidden'} text-center mx-auto bg-gradient-to-b from-slate-700/0 to-slate-400/20 p-4 rounded-b-3xl backdrop-blur-sm`}>
          ...
          <a href="https://drive.google.com/file/d/1s7H0uSHBkJJZISJE-9LrZkQThxoUTB8k/view?usp=share_link" className="text-blue-300 text-[4vw]  font-Montserrat font-bold rounded-xl px-3 py-4 bg-gradient-to-br from-slate-900 to-slate-700 mb-2"><button >Whitepaper</button></a>
          <a href="https://linktr.ee/realbeastverse" className="text-blue-300 text-[4vw]  font-Montserrat font-bold rounded-xl px-3 py-4 bg-gradient-to-br from-slate-900 to-slate-700 mb-2"><button >Socials</button></a>
          </div>
          </li>
          
          <li >
            <div className="grid grid-flow-col grid-cols-2 mx-auto gap-2 ">
            <button className="text-gray-300 text-[4vw]  font-Montserrat font-bold rounded-xl px-3 py-4 bg-gradient-to-br from-slate-900 to-slate-700 mb-2">Buy Eggs</button>
