  ...
  return (
    <>
      <div className="bg-gradient-to-b from-black to-slate-800 text-center min-h-[100vh] flex flex-col items-center justify-center max-[768px]:pt-10 max-[768px]:justify-start p-2">
        ...
        <table className="w-[80vw] border-blue-400">
        <thead>
          <tr className="text-xl lg:text-2xl text-white font-semibold text-left  ">
            <th  className="p-3 border border-blue-400 border-l-1 w-[30vw]">Minted eggs</th>
