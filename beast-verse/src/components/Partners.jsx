    ...
    <div className='bg-black text-center py-20 px-40 pb-32 max-[740px]:px-10'>
        ...
        <div className='flex flex-row items-start justify-center'>
            <div className=' flex flex-col items-center'>
                ...
                <a href="https://nftcalendar.io/"><div className='p-10 pt-4 border border-t-4 border-blue-500 border-x-0 border-b-0 rounded-xl bg-gradient-to-br from-blue-400/20 to-slate-900/70 flex flex-col items-center justify-center'>
