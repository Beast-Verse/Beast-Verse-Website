function Team(){
    return(
        <div class=" px-6 py-20 bg-gradient-to-br from-slate-900 to to-black mt-[]">
        <section class="">
        <div class="grid gap-x-6 lg:gap-x-12 md:grid-cols-3 px-80">
      <div class="mb-24 md:mb-0">
        <div class="rounded-lg shadow-lg h-full block bg-white">
          <div class="flex justify-center">
            <div class="flex justify-center">
              {/* <img src="" class="rounded-full mx-auto shadow-lg" alt="" style="width: 150px" /> */}
            </div>
          </div>
          <div class="p-6">
