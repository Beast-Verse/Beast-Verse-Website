        ...
        <div className="grid grid-flow-row grid-rows-2 bg-slate-800">
            ...
            <div className="grid grid-flow-col grid-cols-2">
                <button className=" w-full mx-auto bg-green-400 font-Monstserrat  text-white">
                    <div onClick={() => setShow1(true) & setShow2(false) & setShow3(false) & setShow4(false)} className="bg-slate-800 p-8 transition-all hover:opacity-90 duration-500">
                        <h3 className="font-Monstserrat text-white ">Forest</h3>
                    </div>
                </button>
                
                <button className=" w-full mx-auto bg-red-400 font-Monstserrat  text-white">
                <div onClick={() => setShow2(true) & setShow1(false)& setShow3(false)&setShow4(false)} className="bg-slate-800 p-8 transition-all hover:opacity-90 duration-500">
